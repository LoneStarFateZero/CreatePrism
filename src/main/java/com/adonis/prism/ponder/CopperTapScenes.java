...
public class CopperTapScenes {
    ...
    public static void tap(SceneBuilder builder, SceneBuildingUtil util) {
        ...
        scene.overlay().showText(100)
                ...
                .text("Copper Taps draw prism from containers behind them and can fill Cauldrons or Basins below")
...
// 模拟工作盆填充效果
    ...
    // 创建细流流体效果
    private static void createFluidStream(CreateSceneBuilder scene, Vec3 start, Vec3 end, FluidStack prism) {
        ParticleOptions particle = FluidFX.getFluidParticle(prism);
